...
@title_slide_background_image = 'image/background-title.jpg'
@slide_background_image = 'image/background-normal.png'

@item_image_1 = 'image/dot-1.png'
@item_image_2 = 'image/dot-2.png'
@item_image_3 = 'image/dot-2.png'
...
match(TitleSlide, Title) do |title|
  title.padding_top = @space * 15
  title.padding_bottom = @space * 3
